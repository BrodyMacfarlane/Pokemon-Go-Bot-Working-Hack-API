...
def get_pos_by_name(location_name):
    ...
    return (34, -118, 0.0) # INSERT YOUR LONGITUDE AND LATITUDE AND ALTITUDE HERE
...
def main():
    ...
    api = PGoApi(CP_CUTOFF=100) # HERE IS THE CP OF THE POKEMON THAT YOU DON'T WANT || CHANGE CP HERE
    ...
    # ----------------------
    api.release_pokemon(pokemon_id = 19)
    api.release_pokemon(pokemon_id = 21)
